...
if TOKEN_CSFR:
    ...
    CRFS_TRUSTED_ORIGINS = ['https://projetohashflix-production-1366.up.railway.app/']
else:
...
ALLOWED_HOSTS = ["projetohashflix-production-1366.up.railway.app", "localhost", "127.0.0.1"]
